...
import { HorseEditComponent} from './pages/horse-edit/horse-edit.component';
...
const routes: Routes = [
    ...
    { path: 'horses/:id',  loadChildren: './pages/horse-edit/horse-edit.module#HorseEditModule' , canActivate: [AuthGuard] },
    { path: 'horses',  loadChildren: './pages/horse-list/horse-list.module#HorseListModule' , canActivate: [AuthGuard] },
